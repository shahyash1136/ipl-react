...
class Teams extends Component {
    ...
    render() {
        let team = this.state.All.map(team => {
            let wins;
            wins = team.isChampion ? team.year : '';

            return <Team key={team.id} teamId={team.id} teamName={team.fullName} homeGround={team.venue} wins={wins} primaryColor={team.primaryColor} secondaryColor={team.secondaryColor} isChampion={team.isChampion} />
        })
        return (
